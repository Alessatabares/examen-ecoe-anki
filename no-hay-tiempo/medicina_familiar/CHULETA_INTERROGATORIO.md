# Chuleta interrogatorio medicina familiar — tronco + llave (para recitar en voz alta)

> **Regla:** abres con el **TRONCO** (lo que preguntas igual en todo el grupo) y cierras con la
> **LLAVE** (la pregunta que separa una enfermedad de otra). Memorizas 8 troncos + 1 llave por enfermedad.
>
> **Reflejo de 1er contacto, antes de etiquetar como banal:** signos vitales + **¿hay banderas rojas?**
> + en el crónico **¿está al día en tamizaje y vacunas?**

---

## 8 TRONCOS (el guion de apertura por motivo de consulta)

**1. Tos / respiratorio** → tiempo · fiebre · esputo (color/cantidad) · disnea · dolor pleurítico · sibilancias · **tabaquismo** · contactos · vacunas · comorbilidad (asma/EPOC/IC).

**2. ORL (oído/nariz/garganta)** → localización · tiempo · fiebre · otorrea/rinorrea · dolor al tragar / **al traccionar el pabellón** · voz · contexto viral/alérgico · recurrencia.
...
**6. Lumbalgia** → mecánico vs inflamatorio · irradiación a pierna · **déficit (fuerza/sensibilidad/esfínteres)** · trauma · **banderas** (fiebre, ↓peso, cáncer, edad, nocturno).

**7. Síntomas urinarios** → disuria/polaquiuria/urgencia · fiebre · dolor lumbar · hematuria · **chorro/vaciado (LUTS)** · **embarazo** · sexo/edad · sonda · complicación (DM, litiasis).
...
| Síntoma guía | Pregunta-llave | Dx |
|---|---|---|
| Fiebre + tos productiva + pleurítico | **¿Confusión/edad (CURB-65)? ¿crepitos?** | Neumonía (NAC) |
| Sibilancias episódicas reversibles | **¿Peor de noche / con gatillos? ¿atopia?** | Asma |
| Disnea + tos crónica en fumador | **¿Tabaquismo + disnea progresiva?** | EPOC |
| Catarro leve sin fiebre alta | **¿Rinorrea/odinofagia leve pocos días?** | IVAS / resfriado |
| Odinofagia + exudado + sin tos | **¿Fiebre + exudado + adenopatías (Centor)?** | Faringitis estreptocócica |
| Otalgia + fiebre + tímpano abombado | **¿Dolor SIN aumentar al traccionar pabellón?** | Otitis media aguda |
| Dolor facial + congestión >10 días | **¿Empeora tras mejorar? ¿purulenta?** | Sinusitis |
| Estornudos + prurito + moco claro | **¿Recurrente/estacional? ¿atopia?** | Rinitis alérgica |
...
| Lumbalgia mecánica tras esfuerzo | **¿SIN banderas (déficit/fiebre/↓peso/esfínteres)?** | Lumbalgia inespecífica |
| Disuria + polaquiuria sin fiebre (mujer) | **¿Sin fiebre/lumbar? ¿sin complicación?** | Cistitis no complicada |
...
## LLAVES MENOS PREGUNTADAS (segunda pasada)
